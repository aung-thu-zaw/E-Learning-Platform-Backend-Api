...
use App\Models\CourseIntroVideo;
...
class CourseFactory extends Factory
{
    ...
    /**
     * Create intro video for the course.
     */
    private function createIntroVideo(Course $course): void
    {
        CourseIntroVideo::factory()->create(['course_id' => $course->id]);
    }
}
